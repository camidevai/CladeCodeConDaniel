    ...
    <footer className="bg-surface border-t border-border">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-medium text-text mb-3">Contacto</h4>
            <p className="text-sm text-muted mb-3">
              Para trabajos, charlas o colaboraciones:
            </p>
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="mailto:dan.avila7@gmail.com"
                ...
                >
                  ...
                  <span className="break-all">dan.avila7@gmail.com</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="break-all">camidevai@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-bg border border-border flex items-center justify-center hover:bg-accent hover:border-accent hover:text-white transition-all duration-200"
                aria-label="LinkedIn Daniel Ávila"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="https://www.linkedin.com/in/camilabanares/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-bg border border-border flex items-center justify-center hover:bg-accent hover:border-accent hover:text-white transition-all duration-200"
                aria-label="LinkedIn CamiDevAI"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
