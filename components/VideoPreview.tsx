...
const previousClasses = [
  {
    ...
    title: "Clase 1 — Título próximamente",
    description: "Primera clase del curso gratuito de Claude Code",
    duration: "Clase 1",
  },
  {
    id: 2,
    ...
    title: "Clase 2 — Título próximamente",
    description: "Segunda clase del curso gratuito de Claude Code",
    duration: "Clase 2",
  },
];
