          ...
          <div className="bg-surface border border-border rounded-2xl p-8 sm:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-muted text-lg mb-8">
                Únete a la Comunidad 4 de WhatsApp para recibir la fecha confirmada, recordatorios y conectar con otros estudiantes.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted text-center">
                Las comunidades 1, 2 y 3 están llenas. ¡Asegura tu lugar en la cuarta!
              </p>
            </div>
          </div>
