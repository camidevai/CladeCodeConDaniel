    ...
    <main className="min-h-screen bg-bg">
      ...
      <section className="py-20 sm:py-28 lg:py-36">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          {/* Community Progress - Estado de las comunidades */}
          <div className="mb-16">
            <CommunityProgress />
          </div>
          ...
          <div className="bg-surface border border-border rounded-2xl p-8 sm:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-muted text-lg mb-8">
                Únete a la Comunidad 3 de WhatsApp para recibir la fecha confirmada, recordatorios y conectar con otros estudiantes.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                <span className="inline-flex items-center justify-center gap-2">
                  ...
                  Unirme a la Comunidad 3
                </span>
              </a>

              <p className="text-sm text-muted text-center">
                Las comunidades 1 y 2 están llenas. ¡Asegura tu lugar en la tercera!
              </p>
            </div>
          </div>
